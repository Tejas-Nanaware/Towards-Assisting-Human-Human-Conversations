...
function updateResponses(text) {
    ...
    // var Blenderbot_paragraph = document.getElementById('BlenderbotAsync');
    // Blenderbot_paragraph.innerHTML = "Async Blenderbot: ";

    io.sockets.emit('update-Blenderbot',{"url": Blenderbot_request});
    io.sockets.emit('update-DialoGPT',{"url": DialoGPT_request});
    console.log(text);
